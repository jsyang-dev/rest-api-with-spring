...
import me.study.restapiwithspring.accounts.CurrentUser;
import me.study.restapiwithspring.common.ErrorsResource;
...
public class EventController {
    ...
    @PostMapping
    public ResponseEntity<EntityModel<?>> createEvent(@RequestBody @Valid EventDto eventDto,
                                                      Errors errors,
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EntityModel<?>> getEvent(@PathVariable Integer id,
                                                   @CurrentUser Account account) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EntityModel<?>> updateEvent(@PathVariable Integer id,
